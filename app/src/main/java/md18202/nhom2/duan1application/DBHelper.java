    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        * Cấu trúc cột: sanPham_id, loaiSanPham_id, tenSanPham, anhSanPham, giaSanPham, moTa, soLuongConLai*/
        ...
        db.execSQL("insert into SANPHAM values" +
                "(1, 1, 'Vỡ nữ cố thấp 01', 'link img1', 15000, 'Vớ nữ cổ thấp chất liệu trơn thoáng mát',50)," +
                "(2, 2, 'Vớ nam cổ cao 01', 'link img2', 18000, 'Vớ nam cổ cao chất liệu cotton khử mùi, thoáng mát',30)," +
                "(3, 3, 'Vỡ nam thể thao cổ trung 01', 'link img3', 17000, 'Vớ thể thao nam cổ trung, êm chân thoát mát',40)," +
                "(4, 4, 'Vỡ lười nam nữ 01', 'link img4', 20000, 'Vớ lười nam/nũ chất liệu cao cấp',60)," +
                "(5, 5, 'Vớ nữ họa tiết ô vuông 01', 'link img5', 25000, 'Vớ nũ họa tiết cá tính',45)");
